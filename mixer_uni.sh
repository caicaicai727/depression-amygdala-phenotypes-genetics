...
###
python3.8 mixer/mixer-master/precimed/mixer_figures.py combine --json test/mixer/result/MDD2025_noMHC.csv.gz.fit.rep@.json --out test/mixer/result/MDD2025_noMHC.csv.gz.fit.rep.all
python3.8 mixer/mixer-master/precimed/mixer_figures.py one --json test/mixer/result/MDDnoMHC.csv.gz.fit.rep.all.json --out test/mixer/result/MDD2025_noMHC.csv.gz.fit.rep.all --statistic mean std

for i in `cat test/amygdala_phenotypes`;do
